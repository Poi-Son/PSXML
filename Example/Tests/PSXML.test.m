...
- (void)testKeyPath{
    ...
    PSXMLElement *element = [dom.rootElement elementAtPath:@"infos.info.f"];
...
- (void)testBuildXML{
    PSXMLElement *request = [PSXMLElement elementWithName:@"request"];
    [request.elements addObject:[PSXMLElement elementWithName:@"request_metnod" andContent:@"addrlistservice_sync_delcontact"]];
    [request.elements addObject:[PSXMLElement elementWithName:@"timestamp" andContent:@"2016-01-12 10:10:53"]];
    [request.elements addObject:[PSXMLElement elementWithName:@"app_key" andContent:@"siguser"]];
    [request.elements addObject:[PSXMLElement elementWithName:@"sid" andContent:@"MTQ1MjU2MTI5OTAwMDAxNzEw004137CC000001"]];
    [request.elements addObject:[PSXMLElement elementWithName:@"rmkey" andContent:@"2741281452561299"]];
